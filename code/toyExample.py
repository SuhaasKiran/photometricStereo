...
if __name__ == '__main__':
    ...
    imarray = prepareData(imarray, ambient)
    calcAlbedos, calcNormals = photometricStereo(imarray, lightdirs)
    calcDepth = getSurface(calcNormals, method="row-column")

    displaySurfaceNormals(calcNormals)
    displayOutput(calcAlbedos, calcDepth)
